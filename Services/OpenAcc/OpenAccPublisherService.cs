...
{
    public class OpenAccPublisherService : BackgroundService
    {
        ...
        public OpenAccPublisherService(
            ILogger logger,
                    ...
                    if (queryResponse.Count() != 0)
                    {
                        ...
                        foreach (var response in queryResponse)
                        {
                            var messageModel = new QueueMessageModel<BatchProcessQueueDetailRequestDto>()
                            {
                                ...
                                checkType = CheckType.OpenAccChecker
                            };
                            ...
                            _publisher.Publish(message, queueName.OpenAccQueueName);
