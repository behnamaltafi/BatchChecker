...
{
    public class SamaChequePublisherService : BackgroundService
    {
        ...
        public SamaChequePublisherService(
          ILogger logger,
        ...
        private async Task BackgroundProcessing(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    var checker = _checkerFactory.CreateChecker<BatchProcessQueueDetailRequestDto>(CheckType.SamaChequeChecker);
                    ...
                    if (queryResponse.Count() != 0)
                    {
                        ...
                        _logger.Information($"BulkUpdate SamaChequeBatchMappingQueueDetail Count:{lstBatchProcessQueue.Count}");
                    }
